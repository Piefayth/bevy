...
struct UiVertexOutput {
    ...
    // The legacy circular border radius in pixels. Order is top left, top right, bottom right,
    // bottom left. This remains part of the public UI material shader ABI.
